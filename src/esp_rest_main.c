...
#define WIFI_SSID "LabAIX_intern"
#define WIFI_PASSWORD "3962f30ff77b7ec672323e53887c124ab38006fd513b2fa42943b61a19f8e7b6"
...
{
    ESP_LOGI(TAG, "new event was captured");

    if (event_base == WIFI_EVENT && event_id == WIFI_EVENT_STA_START)
    {
        ESP_LOGI(TAG, "event_id = WIFI_EVENT_STA_START");

        esp_wifi_connect();
    }
    else if (event_base == WIFI_EVENT && event_id == WIFI_EVENT_STA_DISCONNECTED)
    {
        ESP_LOGI(TAG, "event_id = WIFI_EVENT_STA_DISCONNECTED");
    ...
    {
        ESP_LOGI(TAG, "event_id = IP_EVENT_STA_GOT_IP");
